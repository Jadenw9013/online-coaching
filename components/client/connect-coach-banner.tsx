...
export function ConnectCoachBanner() {
  return (
    <div className="rounded-2xl border border-white/[0.08] bg-white/[0.04] px-5 py-5">
      <h2 className="text-base font-semibold text-zinc-100">Find a Coach</h2>
      <p className="mt-1 text-sm text-zinc-400">
        Browse verified coaches, read reviews, and request coaching directly.
      </p>
      <Link
        href="/coaches"
        className="mt-4 inline-flex min-h-[44px] items-center gap-1.5 rounded-xl bg-blue-600 px-4 py-2.5 text-sm font-semibold text-white transition-all hover:bg-blue-500 active:scale-[0.97]"
      >
        Explore Coaches
