  ...
  return (
    <div className="space-y-5">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-end gap-3 pt-1">
            ...
            <button
              ...
              className="rounded-xl bg-zinc-100 px-5 py-2.5 text-sm font-semibold text-zinc-900 transition-colors hover:bg-white disabled:cursor-not-allowed disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-500"
            >
      ...
      <div className="rounded-2xl border border-white/[0.08] bg-white/[0.04]">
        ...
        {viewMode === "preview" ? (
          /* Preview */
          <div className="space-y-0 divide-y divide-white/[0.06]/80">
            {days.length === 0 ? (
      ...
      <div className="flex items-center justify-between gap-3">
        <button
          ...
          className="rounded-xl px-4 py-2.5 text-sm font-semibold text-red-500 transition-colors hover:bg-red-500/10 disabled:cursor-not-allowed disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500"
        >
