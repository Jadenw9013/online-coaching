  ...
  if (!editing) {
    return (
      <button
        ...
        className="rounded px-1.5 py-0.5 text-sm tabular-nums transition-colors hover:bg-white/[0.06] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-500"
      >
        {quantity}{unit}
      </button>
    );
  ...
  return (
    <div className="flex flex-wrap items-center gap-1">
      <input
        ...
        onBlur={commit}
        aria-label="Quantity"
        className="w-14 rounded border border-white/[0.1] px-1.5 py-0.5 text-sm tabular-nums focus-visible:border-zinc-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-500"
      />
      <input
        type="text"
        value={tempUnit}
        ...
        onBlur={commit}
        aria-label="Unit"
        className="w-14 rounded border border-white/[0.1] px-1.5 py-0.5 text-sm focus-visible:border-zinc-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-500"
      />
...
function AdjustChip({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className="rounded border border-white/[0.1] px-1.5 py-0.5 text-xs tabular-nums transition-colors hover:bg-white/[0.06] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-500"
    >
      {label}
    </button>
  );
