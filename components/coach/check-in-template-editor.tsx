  ...
  return (
    <div className="space-y-5">
      ...
      <div className="rounded-lg border border-white/[0.08] bg-white/[0.04] px-4 py-4">
        <div>
          ...
          <input
            ...
            className="block w-full rounded-lg border border-white/[0.1] px-3 py-2 text-sm focus-visible:border-zinc-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-500"
          />
        </div>
      </div>
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          ...
          <button
            type="button"
            onClick={addQuestion}
            className="rounded-lg border border-white/[0.1] px-3 py-1.5 text-xs font-medium transition-colors hover:bg-white/[0.06] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-500"
          >
            + Add Question
          </button>
        </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex flex-col gap-0.5 pt-1">
                <button
                  ...
                  disabled={i === 0}
                  className="text-xs text-zinc-400 hover:text-zinc-400 disabled:opacity-30"
                  aria-label="Move up"
                >
                  &#9650;
                </button>
              ...
              <div className="flex-1 space-y-2">
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 rounded-lg border border-white/[0.1] px-3 py-1.5 text-sm focus-visible:border-zinc-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-500"
                  />
                  <select
                    value={q.type}
                    onChange={(e) =>
                    ...
                    className="rounded-lg border border-white/[0.1] px-2 py-1.5 text-sm focus-visible:border-zinc-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-500"
                  >
                ...
                {q.type === "scale" && (
                  <div className="flex items-center gap-2 text-xs text-zinc-500">
                    ...
                    <input
                      ...
                      className="w-14 rounded border border-white/[0.1] px-2 py-1 text-xs"
                    />
                    <span>Max:</span>
                    <input
                      type="number"
                ...
                {q.type === "number" && (
                  <div className="flex items-center gap-2 text-xs text-zinc-500">
                    ...
                    <input
                      ...
                      className="w-28 rounded border border-white/[0.1] px-2 py-1 text-xs"
                    />
                  </div>
                )}
                ...
                <div className="flex items-center gap-3">
                  <label className="flex items-center gap-1.5 text-xs text-zinc-500">
                    <input
                      ...
                      className="h-3.5 w-3.5 rounded border-white/[0.1]"
                    />
                    Required
                  </label>
                </div>
      ...
      <button
        ...
        onClick={handleSave}
        disabled={isPending}
        className="rounded-lg bg-zinc-100 px-5 py-2.5 text-sm font-semibold text-zinc-900 transition-colors hover:bg-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-500 focus-visible:ring-offset-2 disabled:opacity-50"
      >
