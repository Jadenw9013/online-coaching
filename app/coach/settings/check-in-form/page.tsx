  ...
  return (
    <div className="mx-auto max-w-2xl space-y-5">
      ...
      <div className="flex items-center gap-3">
        <Link
          href="/coach/settings"
          className="flex h-11 w-11 items-center justify-center rounded-lg text-zinc-400 transition-colors hover:bg-zinc-800 hover:text-zinc-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-500"
